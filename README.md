# Комаров Дмитрий [d9k]: Портфолио FullStack-разработчика
...
- :point_right: [К портфолио работ](https://github.com/d9k/d9k-portfolio/#портфолио-работ)
...
:information_source: _Возможны индивидуальные скидки до 50%, в случае низкой загруженности и интересного заказа_
...
| **Предложение**                                                                                                                                                                                                                    | **Стоимость** | **Срок**  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------- |
| <br/> 2D-видеоигра на Phaser.JS <br/> <br/> _(Вид сверху или сбоку. Игра для браузера и как Android-приложение. <br/> Поддержка мыши, клавиатуры, геймпада, сенсорного экрана. <br/> \+ Playable ads, геймификация.)_ <br/> &nbsp; | от 25 000 р.  | от 5 дней |
...
## Присоединюсь к команде

Более 10 лет опыта в web-разработке. Пишу качественный код с понятной документацией.
Разработка/доработка сайтов, web-сервисов, Electron-приложений, плагинов для браузера на любых технологиях.
Разработка игр на Phaser.JS.
Основной опыт: Vue, jQuery, React, NodeJS, PHP, MySQL, PostgreSQL, Lua, Linux, Docker.
Интересно: GoLang, Zig.